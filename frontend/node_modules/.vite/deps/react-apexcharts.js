  ...
  "node_modules/apexcharts/dist/apexcharts.esm.js"() {
      ...
      return s(t2, [{ key: "isMultiFormat", value: function() {
        ...
        if (a2 && s2 && console.warn("ApexCharts: Both old format (numeric series + labels) and new format (series objects with data/parsing) detected. Using old format for backward compatibility."), a2) {
          ...
          for (var r2 = 0; r2 < e2.series.length; r2++)
            void 0 === e2.seriesNames[r2] && e2.seriesNames.push("series-" + (r2 + 1));
          return this.w;
        }
        if (Array.isArray(t3) && t3.every(function(t4) {
          ...
          for (var n2 = 0; n2 < e2.series.length; n2++)
            e2.seriesNames.push(i2.labels[n2] || "series-".concat(n2 + 1));
          return this.w;
        }
        ...
        for (var l2 = 0; l2 < e2.series.length; l2++)
          void 0 === e2.seriesNames[l2] && e2.seriesNames.push("series-" + (l2 + 1));
        return this.w;
        ...
        var r2 = t3.map(function(t4, i3) {
          var a3, r3, n2;
          if (!t4.data || !Array.isArray(t4.data) || 0 === t4.data.length)
            return t4;
          ...
          if (!o2.x && !o2.y)
            return t4;
          var l2 = t4.data[0];
          if ("object" === b(l2) && null !== l2 && (l2.hasOwnProperty("x") || l2.hasOwnProperty("y")) || Array.isArray(l2))
            return t4;
          if (!o2.x || !o2.y || Array.isArray(o2.y) && 0 === o2.y.length)
            return console.warn("ApexCharts: Series ".concat(i3, " has parsing config but missing x or y field specification")), t4;
          var h2 = t4.data.map(function(t5, a4) {
            if ("object" !== b(t5) || null === t5)
              return console.warn("ApexCharts: Series ".concat(i3, ", data point ").concat(a4, " is not an object, skipping parsing")), t5;
    ...
    ba = function() {
      ...
      return s(t2, [{ key: "init", value: function() {
        ...
        if ("heatmap" === e2.config.chart.type || this.isBarsDistributed) {
          ...
          !t3.target.classList.contains("apexcharts-inactive-legend") && i2 && new $i(this.ctx).toggleSeriesOnHover(t3, t3.target);
    ...
    Ha = function() {
      ...
      return s(t2, [{ key: "draw", value: function(t3) {
        ...
        for (var e2 = this, i2 = this.w, a2 = t3.parent, s2 = new Ea(this.ctx), r2 = i2.globals.yAxisScale[0].result.reverse(), n2 = r2.length, o2 = [], l2 = this.size / (n2 - 1), h2 = 0; h2 < n2; h2++)
          o2[h2] = l2 * h2;
        o2.reverse();
        var c2 = [], d2 = [];
    ...
    _a = function(t2) {
      for (var e2, i2, a2, s2, r2 = function(t3) {
        for (var e3 = [], i3 = t3[0], a3 = t3[1], s3 = e3[0] = Ba(i3, a3), r3 = 1, n3 = t3.length - 1; r3 < n3; r3++)
          i3 = a3, a3 = t3[r3 + 1], e3[r3] = 0.5 * (s3 + (s3 = Ba(i3, a3)));
        return e3[r3] = s3, e3;
      }(t2), n2 = t2.length - 1, o2 = [], l2 = 0; l2 < n2; l2++)
        a2 = Ba(t2[l2], t2[l2 + 1]), Math.abs(a2) < 1e-6 ? r2[l2] = r2[l2 + 1] = 0 : (s2 = (e2 = r2[l2] / a2) * e2 + (i2 = r2[l2 + 1] / a2) * i2) > 9 && (s2 = 3 * a2 / Math.sqrt(s2), r2[l2] = s2 * e2, r2[l2 + 1] = s2 * i2);
        ...
        if (r2.comboCharts) {
          ...
          if (n2.bar.series.length > 0)
            if (s2.chart.stacked) {
              ...
              a2.bar = new Ia(a2, e2), p2.push(a2.bar.draw(n2.bar.series, n2.bar.i));
